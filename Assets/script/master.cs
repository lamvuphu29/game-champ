...
public class master : MonoBehaviour
{
    ...
    void UI()
    {
        ...
        sheild_bar.localScale = new Vector3(player.sheild_hp / 200f, 0.5F, 0);
        white_bar_2.localScale = new Vector3(player.max_sheild_hp / 200f, 0.5F, 0);



        health_bar.position = new Vector3(player.hp / 2 / 200f - 8, 4.5f, 0);
        white_bar_1.position = new Vector3(player.max_hp / 2 / 200f - 8, 4.5f, 0);
        sheild_bar.position = new Vector3(player.sheild_hp / 2 / 200f - 8, 3.75F, 0);
        white_bar_2.position = new Vector3(player.max_sheild_hp / 2 / 200f - 8, 3.75F, 0);
    }
}
